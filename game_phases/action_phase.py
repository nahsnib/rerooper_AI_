class ActionPhase:
    ...
    def execute(self):
        board = Board()
        board.characters = self.character_manager.characters

        scriptwriter = Player("劇本家", self.scriptwriter_actions)
        detective = Player("偵探", self.detective_actions)
