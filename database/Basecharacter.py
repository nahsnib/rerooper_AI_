            ...
            friendly_abilities=[
                {
                    ...
                    'active': True, # 主動能力
                    'target_required': False,'effect': None, #目前難以設計，先略過。
        ...
        BaseCharacter(
            ...
            friendly_abilities=[
                ...
                },
                {
                    ...
                    'active': True, # 主動能力
                    'target_required': True,
                    'target_condition': lambda target, character: (
                        hasattr(target, 'current_location') and target.current_location == character.current_location
                    ) or target == character.current_location,
                    'effect': lambda target: target.change_conspiracy(1),
                    'limit_use': False
                }
            ]
