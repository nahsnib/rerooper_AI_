...
basic_tragedy_y.add_event(event1)
basic_tragedy_y.add_event(event2)
basic_tragedy_y.add_event(event3)
basic_tragedy_y.add_event(event4)
basic_tragedy_y.add_event(event5)
basic_tragedy_y.add_event(event6)
basic_tragedy_y.add_event(event7)
basic_tragedy_y.add_event(event8)
basic_tragedy_y.add_event(event9)
...
# 將這些規則添加到基礎悲劇 Y 中
for rule in additional_main_rules:
    basic_tragedy_y.add_main_rule(rule)

for rule in additional_sub_rules:
    basic_tragedy_y.add_sub_rule(rule)
...
basic_tragedy_z.add_event(event1)
basic_tragedy_z.add_event(event2)
basic_tragedy_z.add_event(event3)
basic_tragedy_z.add_event(event4)
basic_tragedy_z.add_event(event5)
basic_tragedy_z.add_event(event6)
basic_tragedy_z.add_event(event7)
basic_tragedy_z.add_event(event8)
basic_tragedy_z.add_event(event9)
...
# 將這些規則添加到基礎悲劇 Z 中
for rule in additional_main_rules:
    basic_tragedy_z.add_main_rule(rule)

for rule in additional_sub_rules:
    basic_tragedy_z.add_sub_rule(rule)
...
basic_tragedy_w.add_event(event1)
basic_tragedy_w.add_event(event2)
basic_tragedy_w.add_event(event3)
basic_tragedy_w.add_event(event4)
basic_tragedy_w.add_event(event5)
basic_tragedy_w.add_event(event6)
basic_tragedy_w.add_event(event7)
basic_tragedy_w.add_event(event8)
basic_tragedy_w.add_event(event9)
...
# 將這些規則添加到基礎悲劇 w 中
for rule in additional_main_rules:
    basic_tragedy_w.add_main_rule(rule)

for rule in additional_sub_rules:
    basic_tragedy_w.add_sub_rule(rule)
