...
additional_sub_rules = [
    Rule(3, "友情小圈圈", "朋友*2，誤導者*1"),
    Rule(4, "戀愛的模樣", "戀人*1，情人*1"),
    Rule(5, "殺人魔潛伏", "朋友*1，殺人魔*1"),
    Rule(6, "人心惶惶", "每輪迴一次，腳本家可以在能力階段使任意地區+1陰謀。"),
    Rule(7, "惡性譫妄病毒", "誤導者*1。本遊戲中，普通人不安>2時，變成殺人魔。"),
    Rule(8, "因果之線", "輪迴重啟後，前一輪迴友好>0的角色+2不安。"),
    Rule(9, "不定因子", "因子*1")
]
