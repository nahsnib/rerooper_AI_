...
from game_phases.player_detective.player_RA_phase import PlayerRoleAbilityPhase
...
class GameLoop:
    ...
    def run(self):
        while True:
            ...
            self.role_phase.ability_phase.start()
            self.friendship_phase.execute_ability()
