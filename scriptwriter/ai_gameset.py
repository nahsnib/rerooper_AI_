...
class AIGameSet:
    ...
    def assign_roles(self):
        ...
        if self.pre_game.madoka_flag:
            ...
            role_name_list.remove("關鍵人物")  # 已分配，從列表移除
        ...
        for role_name in role_name_list:
            chosen_character = random.choice(available_characters)  # 隨機選擇
            available_characters.remove(chosen_character)  # 移除已分配角色
